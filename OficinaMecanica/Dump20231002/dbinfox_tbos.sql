...
CREATE TABLE `tbos` (
  ...
  CONSTRAINT `tbos_ibfk_1` FOREIGN KEY (`idclient`) REFERENCES `tbclientes` (`idclient`)
...
INSERT INTO `tbos` VALUES (1,'2023-10-02 03:18:00','astra','motor falhando','troca de velas','lucas',325.60,1),(2,'2023-10-02 03:20:31','astra','motor falhando','troca de velas','lucas',325.60,1);
...
-- Dump completed on 2023-10-02  0:31:36
